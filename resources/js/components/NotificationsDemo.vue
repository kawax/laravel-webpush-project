    ...
    export default {
        ...
        methods: {
            ...
            updateSubscription (subscription) {
                ...
                axios.post('/subscriptions', data).then(() => { this.loading = false })
            },
            ...
            sendNotification () {
                ...
                axios.post('/notifications').catch(error => console.log(error)).then(() => { this.loading = false })
            },

            sendUsersNotification () {
                this.loading = true

                axios.post('/notifications/all').catch(error => console.log(error)).then(() => { this.loading = false })
            },
